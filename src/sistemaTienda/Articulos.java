...
public class Articulos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        if (tarticulos.getColumnModel().getColumnCount() > 0) {
            ...
            tarticulos.getColumnModel().getColumn(2).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(3).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(4).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(5).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(6).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(7).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(8).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(9).setPreferredWidth(20);
            tarticulos.getColumnModel().getColumn(10).setPreferredWidth(20);
        }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 1447, Short.MAX_VALUE)
                    .addContainerGap()))
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(titl, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                        .addGap(30, 30, 30))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
